...
ALIGNMENT_DIR_PSE1 = './data.PSE1'

PSE1_ATTRIBUTES = {
    'alignment_directory': ALIGNMENT_DIR_PSE1,
    'alignment':  ALIGNMENT_DIR_PSE1+'/PSE1_natural_>85%ungapped_5K_subsample.a2m',
    'vae_file_prefix': 'PSE1_2latent_5ksubsample',
}
...
def loadOrCreateVAEModel(attributes):
    ...
    try:
        ...
        trainVAEModel(attributes, vae_model)#takes days on a normal cpu, hours on a gpu
        vae_model = loadVAEModel(attributes)
        vae_model = loadVAEParameters(attributes, vae_model)
    return vae_model


loadOrCreateVAEModel(PSE1_ATTRIBUTES)
